...
class PropertyAdmin(admin.ModelAdmin):
    list_display = ("title", "purpose", "property_type", "price", "area", "city", "status", "is_featured")
    list_filter = ("purpose", "property_type", "status", "is_featured", "is_serviced", "is_furnished")
