# Generated by Django 6.1 on 2026-09-25 12:52
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dashboard', '0002_propertyagentassignment'),
        ('landlords', '0004_alter_documentvault_file'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_type', models.CharField(blank=True, choices=[('nin', 'National ID (NIN)'), ('passport', 'International Passport'), ('driver_license', "Driver's License"), ('voter_card', "Permanent Voter's Card")], max_length=30, null=True)),
                ('id_number', models.CharField(blank=True, max_length=50, null=True)),
                ('is_verified', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('lease', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tenants_via_lease', to='tenancy.lease')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='lease',
            name='tenant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='leases', to='tenancy.tenant'),
        ),
        migrations.CreateModel(
            name='Unit',
            fields=[
        ...
        migrations.AddField(
            model_name='tenant',
            name='unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tenant', to='tenancy.unit'),
        ),
        migrations.AddField(
            model_name='lease',
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='leases', to='tenancy.unit'),
        ),
