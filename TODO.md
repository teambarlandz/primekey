...
- `CONTACT_RECIPIENT_EMAIL` defaults to `hello@primekeyhomesandpropertiesltd.com`

---

## To switch to real Hostinger SMTP

1. Create mailbox `hello@primekeyhomesandpropertiesltd.com` in Hostinger hPanel
...
EMAIL_USE_SSL=True
EMAIL_USE_TLS=False
EMAIL_HOST_USER=hello@primekeyhomesandpropertiesltd.com
